...
import { PitFindManyArgs } from "../../pit/base/PitFindManyArgs";
...
export class GameControllerBase {
  ...
  async findPits(
    ...
    const query = plainToClass(PitFindManyArgs, request.query);
    const results = await this.service.findPits(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  async connectPits(
    @common.Param() params: GameWhereUniqueInput,
    @common.Body() body: PitWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      pits: {
        connect: body,
  ...
  @common.Delete("/:id/pits")
  async disconnectPits(
    @common.Param() params: GameWhereUniqueInput,
    @common.Body() body: PitWhereUniqueInput[]
  ): Promise<void> {
    const data = {
